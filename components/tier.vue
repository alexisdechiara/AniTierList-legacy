<template>
	<div class="flex flex-row min-h-[150px]">
		<div v-if="name != null" :class="[color, color == 'bg-white-500' ? 'text-gray-900' : 'text-white']" class="flex min-h-[150px] min-w-[150px] justify-center items-center font-bold text-5xl"><span>{{name}}</span></div>
